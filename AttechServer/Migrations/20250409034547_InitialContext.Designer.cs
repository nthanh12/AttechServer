...
namespace AttechServer.Migrations
{
    ...
    [Migration("20250409034547_InitialContext")]
            ...
            modelBuilder.Entity("AttechServer.Domains.Entities.Role", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 10, 45, 46, 521, DateTimeKind.Local).AddTicks(3510));
            ...
            modelBuilder.Entity("AttechServer.Domains.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 10, 45, 46, 511, DateTimeKind.Local).AddTicks(2446));
            ...
            modelBuilder.Entity("AttechServer.Domains.Entities.UserRole", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 4, 9, 10, 45, 46, 519, DateTimeKind.Local).AddTicks(9359));
